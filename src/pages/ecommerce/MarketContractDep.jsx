              ...
              <div className="space-y-4">
                ...
                <div className="md:flex space-y-4 md:space-y-0 md:space-x-4">
                  <div className="flex-1">
                    ...
                    >
                      The platform default NFT contract address
                    </label>
                    <input
                      id="card-address"
                  ...
                  <div className="flex-1">
                    <label
                      ...
                      htmlFor="card-address"
                    >
                      The platform default NFT contract type
                    </label>
                    <input
                      id="card-address"
                      className="form-input w-full"
                ...
                <div className="md:flex space-y-4 md:space-y-0 md:space-x-4">
                  <div className="flex-1">
                    <label
                      ...
                      htmlFor="card-address"
                    >
                      Receiving platform fee wallet address
                    </label>
                    <input
                      id="card-address"
                      className="form-input w-full"
                  ...
                  <div className="flex-1">
                    <label
                      ...
                      htmlFor="card-address"
                    >
                      Wallet Registry Registered contract address
                    </label>
                    <input
                      id="card-address"
                      className="form-input w-full"
...
export default MarketContractDep;
