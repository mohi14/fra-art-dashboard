          ...
          <div className="bg-white px-8 pb-6 rounded-b shadow-lg">
            ...
            <div className="text-center mb-6">
              ...
              <h1 className="text-xl leading-snug text-slate-800 font-semibold mb-2">
                Wallet Registry contract deployment 🔥
              </h1>
            </div>
            <form>
                ...
                <div className="md:flex space-y-4 md:space-y-0 md:space-x-4">
                  ...
                  <div className="flex-1">
                    <label
                      ...
                      htmlFor="card-address"
                    >
                    By Default, the transaction token contract address is opened
                    </label>
                    <input
                      id="card-address"
                      className="form-input w-full"
            ...
            <div className="grid grid-cols-2">
              ...
              <div className="bg-gray-100 p-2 border">The default currency is enabled</div>
              <div className="bg-gray-100 p-2 border">TX</div>
              <div className="p-2 border">Test_20Has been opened</div>
              <div className="p-2 border  overflow-hidden">0xkdifhjdgnfjgb</div>
...
export default WalletRegContract;
