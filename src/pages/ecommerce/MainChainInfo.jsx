        ...
        <main>
          <div className="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
            ...
            <div className="sm:flex flex-wrap gap-8 sm:justify-between sm:items-center mb-8">
              ...
              <div>
                ...
                <select className="border-none">
                  <option>Please enter the main chain</option>
              ...
              <div>
                ...
                <input
                  className="border-none"
                  type="text"
                  placeholder="please enter NFT contract"
                />
              </div>
            ...
            <div className="overflow-x-auto">
              <table className="table-auto w-full divide-y divide-slate-200">
                ...
                <thead className="text-xs uppercase text-slate-500 bg-slate-50 border-t border-slate-200">
                  <tr>
                    ...
                    <th className="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap">
                      <div className="font-semibold text-left">Chain Info</div>
                    </th>
                    <th className="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap">
                      <div className="font-semibold text-left">
                        NFT Contract
              ...
              <button className="w-full bg-white border py-3 my-6">
                No Data
              </button>
            </div>
