          ...
          <div className="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
            ...
            <div className="sm:flex flex-wrap gap-8 sm:justify-between sm:items-center mb-8">
              ...
              <div>
                ...
                <input className="border-none" type="text" placeholder="Please enter transaction id" />
              </div>
              <div>
                <label className="mr-2" for="status">
                  Successful bidder
                </label>
                <input className="border-none" type="text" placeholder="Please enter the winning bidder" />
              </div>
              <div>
                <label className="mr-2" for="status">
                  Commodity
