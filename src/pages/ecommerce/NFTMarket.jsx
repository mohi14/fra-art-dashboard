        ...
        <div className="relative px-4 sm:px-6 lg:px-8 pb-8 max-w-lg mx-auto">
          <div className="bg-white px-8 pb-6 rounded-b shadow-lg">
            ...
            <form>
              <div className="space-y-4">
                ...
                <div className="md:flex space-y-4 md:space-y-0 md:space-x-4">
                  <div className="flex-1">
                    ...
                    >
                      The handling fee foe each transaction of the user is
                      price*service fee
                    </label>
                    <input
                      id="card-address"
                  ...
                  <div className="flex-1">
                    ...
                    >
                      DefaultURL <br />
                      <span>
                        Tip: When NFT when not frozen will use the currentURL
                      </span>
                    </label>
                    <input
                      id="card-address"
                ...
                <button
                  className="w-full my-5  bg-blue-500 text-white rounded-lg p-2 "
                  type=""
                >
                  Submit modification
                </button>
                ...
                <div className="md:flex space-y-4 md:space-y-0 md:space-x-4">
                  <div className="flex-1">
                    <label
                      ...
                      htmlFor="card-address"
                    >
                      Registered contract address <br />
                      <span>Registered contract address</span>
                    </label>
                    <input
                      id="card-address"
                      className="form-input w-full"
              ...
              <p className="text-2xl my-4">Set defaultMinter</p>
              <div className="space-y-4">
                {/* 2nd row */}
                <div className="md:flex space-y-4 md:space-y-0 md:space-x-4">
                  <div className="flex-1">
                    ...
                    >
                      DefaultMinter <br />
                      <span>Tip set the market contract address to minter</span>
                    </label>
                    <input
                      id="card-address"
                      className="form-input w-full"
              ...
              <p className="text-2xl my-4">Open market</p>
              <div className="space-y-4">
                {/* 2nd row */}
                <div className="md:flex space-y-4 md:space-y-0 md:space-x-4">
                  <div className="flex-1">
